...
namespace ServerProject.DatabaseLayer
{
	...
	public partial class Movie : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Scheduler> _Schedulers1;
    ...
    partial void OnImageChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Movie_Scheduler1", Storage="_Schedulers1", ThisKey="MovieID", OtherKey="MovieID")]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=7, EmitDefaultValue=false)]
		public EntitySet<Scheduler> Schedulers1
		{
			get
			{
				if ((this.serializing 
							&& (this._Schedulers1.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._Schedulers1;
			}
			set
			{
				this._Schedulers1.Assign(value);
			}
		}
		...
		private void attach_Schedulers1(Scheduler entity)
		{
			this.SendPropertyChanging();
			entity.Movie1 = this;
		}
		
		private void detach_Schedulers1(Scheduler entity)
		{
			this.SendPropertyChanging();
			entity.Movie1 = null;
		}
		...
		{
			this._Schedulers = new EntitySet<Scheduler>(new Action<Scheduler>(this.attach_Schedulers), new Action<Scheduler>(this.detach_Schedulers));
			this._Schedulers1 = new EntitySet<Scheduler>(new Action<Scheduler>(this.attach_Schedulers1), new Action<Scheduler>(this.detach_Schedulers1));
			OnCreated();
		}
    ...
    partial void OnHallIDChanged();
		...
		public System.Nullable<int> MovieID
		{
			...
			set
			{
				if ((this._MovieID != value))
				{
					if ((this._Movie.HasLoadedOrAssignedValue || this._Movie1.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnMovieIDChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Movie_Scheduler1", Storage="_Movie1", ThisKey="MovieID", OtherKey="MovieID", IsForeignKey=true)]
		public Movie Movie1
		{
			get
			{
			...
			set
			{
							...
							|| (this._Movie1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Schedulers1.Remove(this);
					}
					this._Movie1.Entity = value;
					if ((value != null))
					{
						value.Schedulers1.Add(this);
						this._MovieID = value.MovieID;
					}
					else
					{
