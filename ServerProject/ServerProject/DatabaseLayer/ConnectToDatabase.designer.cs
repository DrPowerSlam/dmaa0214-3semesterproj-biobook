...
namespace ServerProject.DatabaseLayer
{
    ...
    partial void InsertHallSeat(HallSeat instance);
    partial void UpdateHallSeat(HallSeat instance);
    partial void DeleteHallSeat(HallSeat instance);
    ...
    partial void DeleteScheduler(Scheduler instance);
		...
		public System.Data.Linq.Table<HallSeat> HallSeats
		{
			get
			{
				return this.GetTable<HallSeat>();
			}
		}
    ...
    partial void OnmailChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_name", DbType="VarChar(30)", UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_mail", DbType="VarChar(50)", UpdateCheck=UpdateCheck.Never)]
	...
	public partial class Hall : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<HallSeat> _HallSeats;
    ...
    partial void OnMaxNumberOfSeatsChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Hall_HallSeat", Storage="_HallSeats", ThisKey="HallID", OtherKey="HallID")]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=4, EmitDefaultValue=false)]
		public EntitySet<HallSeat> HallSeats
		{
			get
			{
				if ((this.serializing 
							&& (this._HallSeats.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		private void attach_HallSeats(HallSeat entity)
		{
			this.SendPropertyChanging();
			entity.Hall = this;
		}
		
		private void detach_HallSeats(HallSeat entity)
		{
			this.SendPropertyChanging();
			entity.Hall = null;
		}
		...
		private void Initialize()
		{
			this._HallSeats = new EntitySet<HallSeat>(new Action<HallSeat>(this.attach_HallSeats), new Action<HallSeat>(this.detach_HallSeats));
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.HallSeats")]
	[global::System.Runtime.Serialization.DataContractAttribute()]
	public partial class HallSeat : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnRowChanging(System.Nullable<int> value);
    partial void OnRowChanged();
    partial void OnseatNumbersChanging(string value);
    ...
    partial void OnHallIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_seatNumbers", DbType="VarChar(45)")]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=3)]
		public string seatNumbers
		{
			get
			{
				return this._seatNumbers;
			}
			set
			{
				if ((this._seatNumbers != value))
				{
					this.OnseatNumbersChanging(value);
					this.SendPropertyChanging();
					this._seatNumbers = value;
					this.SendPropertyChanged("seatNumbers");
					this.OnseatNumbersChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Hall_HallSeat", Storage="_Hall", ThisKey="HallID", OtherKey="HallID", IsForeignKey=true)]
		public Hall Hall
		{
			get
			{
			...
			set
			{
							...
							|| (this._Hall.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.HallSeats.Remove(this);
					}
					this._Hall.Entity = value;
					if ((value != null))
					{
						value.HallSeats.Add(this);
